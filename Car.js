class Car{
    ...
    move(car, trackFactor, line, speed, arr, cb, selectedTrackName, carsArr){
        
        let currentLeft = -60;
        speed = speed * trackFactor;
        let linerGrandLine = document.createElement('div');
        linerGrandLine.classList.add('liner-grand-line');
        if(selectedTrackName === 'Asphalt'){
            linerGrandLine.classList.add('line-gray');
        } else if(selectedTrackName === 'Ice') {
            linerGrandLine.classList.add('line-white');
        } else {
            linerGrandLine.classList.add('line-brown');
        }
        car.childNodes[0].appendChild(linerGrandLine);
        let motionInterval = setInterval(function(){
            currentLeft += speed;
            car.style.left = currentLeft + "px";
            if (currentLeft >= line.offsetWidth - car.offsetWidth - 5) {
                let carBrand = selectedList.list[car.getAttribute('data-pos')].brand;
                document.querySelector('.winner-text').textContent = carBrand + ' is WINNER';
        ...
        arr.push(motionInterval);
    }
    
    
}

class Merseceds extends Car {
    ...
    createElem(){
        ...
        name.textContent = this.brand;
        let speed = document.createElement('p');
        speed.textContent = this.speed + ' px/s';
        
        continer.appendChild(imageBox);
        continer.appendChild(name);
        continer.appendChild(speed);
